...
import scraper.plugins.core.debugger.DebuggerNodeHook;
...
open module scraper.core.plugins {
    ...
    exports scraper.plugins.core.debugger;
    exports scraper.plugins.core.debugger.DTO;
    ...
    provides NodeHook with DebuggerNodeHook;
